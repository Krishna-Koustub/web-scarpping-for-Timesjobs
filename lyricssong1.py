...
spotifyOAuth = spotipy.SpotifyOAuth(client_id=os.environ['f4d41e58e6da4c63a1928f2787260ba2'],
                                    client_secret=os.environ['2eb0822da1174ac6acdebdce54f1ee73'],
                                    redirect_uri=os.environ['https://www.google.com/'],
                                    scope=scope)
...
spotifyObject = spotipy.Spotify(auth=token['AXPJAT1BKGQMKVa9TGQ4LEwvw7WB4-J497QCJkMFl9NCb4_d6AsqijzyPi6tS11m'])

# Create out geniusObject
access_token = os.environ['AXPJAT1BKGQMKVa9TGQ4LEwvw7WB4-J497QCJkMFl9NCb4_d6AsqijzyPi6tS11m']
